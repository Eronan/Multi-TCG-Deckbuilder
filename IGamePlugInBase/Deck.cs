namespace IGamePlugInBase
{
    ...
    public class Deck
    {
        ...
        /// </summary>
        public Func<DeckBuilderCard, IEnumerable<DeckBuilderCard>, IEnumerable<IEnumerable<DeckBuilderCard>>, bool> ValidateAdd { get; set; }
        ...
        public Deck(string name, string label, int expectedDeckSize, Func<DeckBuilderCard, IEnumerable<DeckBuilderCard>, IEnumerable<IEnumerable<DeckBuilderCard>>, bool> validateAdd,
